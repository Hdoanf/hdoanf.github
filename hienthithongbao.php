<?php
session_start();
if (!isset($_SESSION['user']) || $_SESSION['quyenhan'] !== 'admin') {
...
$loaits = "";
$tinh_trang = "";
// $sqlthongbao = $conn->query("SELECT * FROM `thongbao` WHERE");
// if ($sqlthongbao->num_rows > 0) {
//   $rowthongbao = $sqlthongbao->fetch_assoc();
//   $barcodetb = $rowthongbao["barcode"];
// }
$sql = "
  SELECT 
    fi.*, 
        ...
        <div class="position-sticky pt-3">
          <ul class="nav flex-column ">
            ...
            <li class="nav-item nav-pills">
              <a class="nav-link avtive" href="kho.php">
                Kho
              </a>
            </li>
            <li class="nav-item nav-pills">
              <a class="nav-link active" href="hienthithongbao.php">
                Thông Báo
              </a>
            </li>
            <li class="nav-item">
